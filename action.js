...
document.getElementById('product_image').innerHTML='<img style="border-radius:10px;" width="400" height="310" src=photos/'+x+'1.jpg'+' alt="">';
...
function set3(x){
document.getElementById('product_image').innerHTML='<img style="border-radius:10px;" width="400" height="310" src=photos/'+x+'2.jpg'+' alt="">';
}

function set4(x){
document.getElementById('product_image').innerHTML='<img style="border-radius:10px;" width="400" height="310" src=photos/'+x+'3.jpg'+' alt="">';	
}