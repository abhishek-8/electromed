    ...
    <div class="container">
        <div class="row"  style="padding-left: 20px;padding-right: 5px;">
            ...
            <div class="col l2 offset-l1 s12 m2 offset-m1">
                ...
                <ul>
                    <li class="flink"><a class="white-text foot" href="about.php">About Us</a></li>
                    ...
                    <li class="flink"><a class="white-text foot" href="project_list.php">Projects</a></li>
                </ul>
            </div>
            ...
            <div class="col l3 s12 m3">
                ...
                <div class="row">
                    ...
                    <div class="col l8 offset-l1 s11 m8 offset-m1">
                        <p class="white-text foot" style="display:inline;">+91 941 503 9393</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col l1 s1 m1"><i class="material-icons prefix white-text text-darken-2"">email</i></div>
                    <div class="col l8 offset-l1 s11 m8 offset-m1">
                        <p class="white-text foot" style="display:inline;">info@electromed.co.in</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col l1 s1 m1"><i class="material-icons prefix white-text text-darken-2"">room</i></div>
                    <div class="col l8 offset-l1 s11 m8 offset-m1">
                        <p class="white-text foot" style="display:inline;">D -17, Vivekanand Puri,
