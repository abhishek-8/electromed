        ...
        <div class="row">
            ...
            <div class="col l10 m10 s12 offset-l1">
                ...
                <div class="nav-wrapper container" style="float:left">
                    ...
                    <a href="<?php echo $link; ?>" class="breadcrumb black-text" style="font-size: 15px;"><?php echo $category ?></a>
                    <a href="" class="breadcrumb black-text" id="curr" style="font-size: 15px;"><?php echo $title; ?></a>
               </div>
